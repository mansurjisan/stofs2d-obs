...
class ModelObsComparison:
    ...
    def plot_comparison(self, save_path=None):
        ...
        ax1.plot(
            self.model_data.index,
            self.model_data["water_level"],
            "b-",
            linewidth=1.5,
            label=f"{self.model_name} Model",
            alpha=0.8,
        )
        ax1.plot(
            self.obs_data.index,
            self.obs_data["obs_water_level"],
            "r-",
            linewidth=1.5,
        ...
        ax1.set_title(
            f"{self.model_name} vs CO-OPS Observations: {self.station_name}",
            fontsize=14,
            fontweight="bold",
        )
